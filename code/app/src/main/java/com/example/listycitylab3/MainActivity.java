...
public class MainActivity extends AppCompatActivity
    ...
    // Called when a new city is added from AddCityFragment
    @Override
    ...
    // Called after editing an existing city in EditCityFragment
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //Initial data
        ...
        cityList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            EditCityFragment editFragment = EditCityFragment.newInstance(city);
